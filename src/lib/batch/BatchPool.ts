import { BYTES_PER_VERTEX, MAX_VERTEX_COUNT } from '@/constants'
import { WebGLRenderer } from '@/renderer/WebGLRenderer'

export interface Batch {
  vertices: Float32Array // 顶点数组
  vertexIndices: Uint16Array // 顶点下标数组
  rgba: number // rgba的小端序形式
}
...
export class BatchPool {
  ...
  private vertexBufferPool: Record<
    number,
    { float32View: Float32Array; uint32View: Uint32Array }
  > = {}
